...
print("Depth First Search Path: ", construct_path_dfs(dfs, "Euston",tube_data_graph,node_attributes),"\n")

bfs = breadth_first_search(tube_data_graph, "Euston", 'Stepney Green')
print("Breadth First Search Path: ",construct_path_bfs(bfs, "Euston",tube_data_graph,node_attributes),"\n")
